...
export default class QuestionScene extends Phaser.Scene {
  ...
  questionStart() {
    ...
    // Result
    this.resultText = this.add.text(this.gameHalfWidth, 300, "", {
      fontSize: "32px",
      color: "#fc0328",
      fontFamily: "Arial",
      fontStyle: "bold",
  ...
  createButtons() {
    this.number0 = this.input.keyboard.addKey(
      Phaser.Input.Keyboard.KeyCodes.ZERO
    );
    this.number1 = this.input.keyboard.addKey(
      Phaser.Input.Keyboard.KeyCodes.ONE
    );
    this.number2 = this.input.keyboard.addKey(
      Phaser.Input.Keyboard.KeyCodes.TWO
    );
    this.number3 = this.input.keyboard.addKey(
      Phaser.Input.Keyboard.KeyCodes.THREE
    );
    this.number4 = this.input.keyboard.addKey(
      Phaser.Input.Keyboard.KeyCodes.FOUR
    );
    this.number5 = this.input.keyboard.addKey(
      Phaser.Input.Keyboard.KeyCodes.FIVE
    );
    this.number6 = this.input.keyboard.addKey(
      Phaser.Input.Keyboard.KeyCodes.SIX
    );
    this.number7 = this.input.keyboard.addKey(
      Phaser.Input.Keyboard.KeyCodes.SEVEN
    );
    this.number8 = this.input.keyboard.addKey(
      Phaser.Input.Keyboard.KeyCodes.EIGHT
    );
    this.number9 = this.input.keyboard.addKey(
